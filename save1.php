...
//connection create.
$con = mysqli_connect("localhost", "root","","report_generator");
...
//insert into table.
$sql = "INSERT INTO user(names, email, username, pass, confirm_password) VALUES ('$name','$email','$username','$password','$confirmpassword')";
